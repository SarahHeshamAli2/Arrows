...
{x.matches ?<div className="ourClientsImgs w-75 m-auto my-5 ">
<span>
...
</div>:<motion.div viewport={{once:true}} whileInView={{x:0 , opacity:1}} initial={{x:150 , opacity:0}} transition={{ duration: 1.5, type: "tween" }} className="ourClientsImgs w-75 m-auto my-5 ">
        <span>
        <img src={require("../../images/cust1-e1628861795271.png")} alt="" />
