...
<div className="who py-5">
    <div className="container text-white ">
       ...
       <h2 >WHO WE ARE</h2>
        ...
        <div className="row align-items-center py-4 g-5 text-center">
            <motion.div className="col-md-4 px-0" viewport={{once:true}} whileInView={{x:0 , opacity:1}} initial={{x:-300 , opacity:0}} transition={{ duration: 1.5, type: "tween" }}>
                <div className="innerWho w-75 m-auto">
                We believe that your business success is our success
                </div>
            </motion.div>
            <motion.div viewport={{once:true}} className="col-md-4 px-0 mx-0"   initial={{y:200 }}
    whileInView={{y:0}}
    transition={{ duration: 1, type: "tween" }}>
            ...
            <motion.div viewport={{once:true}} whileInView={{x:0 , opacity:1}} initial={{x:80, opacity:0}} transition={{ duration: 1.5, type: "tween" }} className="col-md-4">
